...
- `api/index.js` — swap the `PROFILE`, `PROJECTS`, `SKILLS`, and
  `BEYOND_CODE` objects for your own details. Wire the `/api/contact`
  route to an email service or database when you're ready to go live.
